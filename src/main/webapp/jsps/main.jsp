...
<%--<div class="classify">--%>
    ...
    <%--<ul class="topmenu">--%>
        ...
        <%--<li><a href="#">图书、音像、数字商品</a>--%>
            ...
            <%--&lt;%&ndash;<b><a href="#">文学</a> <a href="#">经管</a>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<a href="#">畅读VIP</a></b>&ndash;%&gt;--%>
            <%--<div class="submenu">--%>
                <%--<div class="leftdiv">--%>
                    <%--<dl>--%>
                        <%--<dt><a href="#">电子书</a></dt>--%>
        ...
        <%--<li><a href="#">个护化妆</a>--%>
            ...
            <%--<div class="submenu">--%>
                <%--<div class="leftdiv">--%>
                    ...
                    <%--</dl>--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">女性护理</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">卫生巾</a> <a href="#">卫生护垫</a> <a href="#">私密护理</a> <a href="#">脱毛膏</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">香水彩妆</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">香水</a> <a href="#">底妆</a> <a href="#">腮红</a> <a href="#">眼部</a> <a href="#">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;唇部</a> <a href="#">美甲</a> <a href="#">美容工具</a> <a href="#">套装</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                <%--</div>--%>
                <%--<div class="rightdiv">--%>
        ...
        <%--<li><a href="#">鞋靴、箱包、钟表、奢侈品</a>--%>
            ...
            <%--<div class="submenu">--%>
                <%--<div class="leftdiv">--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">时尚女鞋</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">凉鞋</a> <a href="#">单鞋</a> <a href="#">高跟鞋</a> <a href="#">坡跟鞋</a> <a&ndash;%&gt;--%>
                                <%--&lt;%&ndash;href="#">松糕鞋</a> <a href="#">鱼嘴鞋</a> <a href="#">休闲鞋</a> <a href="#">帆布鞋</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">拖鞋/人字拖</a> <a href="#">妈妈鞋</a> <a href="#">防水台</a> <a href="#">雨鞋/雨靴</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">内增高</a> <a href="#">布鞋/绣花鞋</a> <a href="#">女靴</a> <a href="#">雪地靴</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">踝靴</a> <a href="#">马丁靴</a> <a href="#">鞋配件</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">流行男鞋</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">休闲鞋</a> <a href="#">凉鞋/沙滩鞋</a> <a href="#">帆布鞋</a> <a href="#">商务休闲鞋</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">正装鞋</a> <a href="#">增高鞋</a> <a href="#">拖鞋/人字拖</a> <a href="#">工装鞋</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">男靴</a> <a href="#">传统布鞋</a> <a href="#">功能鞋</a> <a href="#">鞋配件</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">定制鞋</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--<dl>--%>
                        <%--<dt><a href="#">潮流女包</a></dt>--%>
        ...
        <%--<li><a href="#">运动户外</a>--%>
            ...
            <%--<div class="submenu">--%>
                <%--<div class="leftdiv">--%>
                    ...
                    <%--</dl>--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">户外装备</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">背包</a> <a href="#">帐篷/垫子</a> <a href="#">睡袋/吊床</a> <a href="#">登山攀岩</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">户外照明</a> <a href="#">野餐烧烤</a> <a href="#">便携桌椅床</a> <a href="#">户外工具</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">望远镜</a> <a href="#">户外仪表</a> <a href="#">旅游用品</a> <a href="#">军迷用品</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">救援装备</a> <a href="#">滑雪装备</a> <a href="#">极限户外</a> <a href="#">冲浪潜水</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">户外配饰</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">垂钓用品</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">鱼竿鱼线</a> <a href="#">浮漂鱼饵</a> <a href="#">钓鱼桌椅</a> <a href="#">钓鱼配件</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">钓箱鱼包</a> <a href="#">其它</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">游泳用品</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">泳镜</a> <a href="#">泳帽</a> <a href="#">游泳包防水包</a> <a href="#">男士泳衣</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">女士泳衣</a> <a href="#">比基尼</a> <a href="#">其它</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                <%--</div>--%>
                <%--<div class="rightdiv">--%>
        ...
        <%--<li><a href="#">母婴、玩具乐器</a>--%>
            ...
            <%--<div class="submenu">--%>
                <%--<div class="leftdiv">--%>
                    ...
                    <%--</dl>--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">寝居服饰</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">婴儿外出服</a> <a href="#">婴儿内衣</a> <a href="#">婴儿礼盒</a> <a href="#">婴儿鞋帽袜</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">家居床品</a> <a href="#">安全防护</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl class="0">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">童装童鞋</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">套装</a> <a href="#">上衣</a> <a href="#">裤子</a> <a href="#">裙子</a> <a href="#">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;内衣</a> <a href="#">羽绒服/棉服</a> <a href="#">亲子装</a> <a href="#">配饰</a> <a href="#">演出服</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">运动服</a> <a href="#">运动鞋</a> <a href="#">皮鞋/帆布鞋</a> <a href="#">靴子</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">凉鞋</a> <a href="#">功能鞋</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl class="1">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">玩具乐器</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">适用年龄</a> <a href="#">遥控/电动</a> <a href="#">毛绒布艺</a> <a href="#">娃娃玩具</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">模型玩具</a> <a href="#">健身玩具</a> <a href="#">动漫玩具</a> <a href="#">益智玩具</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">积木拼插</a> <a href="#">DIY玩具</a> <a href="#">创意减压</a> <a href="#">乐器相关</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                <%--</div>--%>
                <%--<div class="rightdiv">--%>
        ...
        <%--<li><a href="#">食品饮料、酒类、生鲜</a>--%>
            ...
            <%--<div class="submenu">--%>
                <%--<div class="leftdiv">--%>
                    ...
                    <%--</dl>--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">生鲜食品</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">水果蔬菜</a> <a href="#">海鲜水产</a> <a href="#">海参</a> <a href="#">牛排</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">肉禽蛋奶</a> <a href="#">熟食腊味</a> <a href="#">环球美食</a> <a href="#">产地直供</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<dl>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dt><a href="#">食品礼券</a></dt>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<dd>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">大闸蟹</a> <a href="#">粽子</a> <a href="#">月饼</a> <a href="#">卡券</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</dd>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</dl>&ndash;%&gt;--%>
                <%--</div>--%>
                <%--<div class="rightdiv">--%>
